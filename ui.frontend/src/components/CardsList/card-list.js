...
import { initGlideJsSlider, galleryHorizontalPadding, getGalleryPeek, getBreakpoint } from '../../js/helpers/glide';
import { breakpoints } from '../../js/constants/breakpoints';
import { getScrollbarWidth } from '../../js/scrollbar';
...
const initCardsListGlideJs = () => {
  initGlideJsSlider('.hl-cards-list--slider.glide', element => {
